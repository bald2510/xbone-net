...
\titleformat*{\subsubsection}{\large\bfseries}
  ...
  \begin{minipage}[c]{1.0\textwidth}
      \centering
      \fontsize{10}{16}\selectfont\textbf{TRƯỜNG ĐẠI HỌC KHOA HỌC TỰ NHIÊN\\KHOA CÔNG NGHỆ THÔNG TIN}
  \end{minipage}
  \vspace{0.8cm}
  ...
  \vspace{.5cm}
      \textit{\textbf{\large (Developing a bone X-ray image classification system based on multimodal deep learning)}}
  \end{center}
