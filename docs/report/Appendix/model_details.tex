...
Hệ số logit của đầu tâm lớp &
  $15{,}0$ &
  \begin{tabular}[c]{@{}l@{}}Nhân với độ tương đồng cosine \\ trước khi cộng độ lệch lớp.\end{tabular} \\ \hline
Độ lệch theo lớp &
  Có, khởi tạo bằng 0 &
  \begin{tabular}[c]{@{}l@{}}Được tối ưu trong pha 2 để hiệu \\ chỉnh ranh giới quyết định theo lớp.\end{tabular} \\ \hline
Cập nhật tâm lớp &
  Mỗi vòng huấn luyện &
  \begin{tabular}[c]{@{}l@{}}Tính lại từ toàn bộ tập huấn luyện \\ trước khi đánh giá trên tập xác thực.\end{tabular} \\ \hline
\end{tabular}%
}
