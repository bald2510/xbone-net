...
\textbf{Về mục tiêu thích nghi biểu diễn:}
Mặc dù BioMedCLIP được tiền huấn luyện bằng học tương phản, việc áp dụng trực tiếp InfoNCE trên dữ liệu đích có thể tạo ra các cặp âm tính giả, do những mẫu khác nhau trong cùng lô vẫn có thể thuộc cùng một lớp hoặc mang nội dung lâm sàng tương đồng. Vì vậy, nghiên cứu lựa chọn hàm mất mát khớp ngữ nghĩa sử dụng phân phối đích mềm theo nhãn lớp. Mục tiêu này vẫn ưu tiên sự tương hợp của cặp ảnh-văn bản thuộc cùng một mẫu, đồng thời giảm mức phạt đối với các mẫu khác có quan hệ ngữ nghĩa gần nhau.

\textbf{Về phương pháp dung hợp đa phương thức:}
Thay vì chỉ ghép nối hai biểu diễn toàn cục, nghiên cứu lựa chọn cơ chế chú ý chéo hai chiều để đặc trưng ảnh có thể lựa chọn các thông tin lâm sàng liên quan và đặc trưng văn bản có thể định hướng mô hình đến các vùng ảnh phù hợp. Cơ chế này phù hợp với bài toán vì mối quan hệ giữa triệu chứng lâm sàng và dấu hiệu X-quang không hoàn toàn đối xứng hoặc tương ứng trực tiếp ở mức toàn cục. Văn bản đầu vào chỉ bao gồm những thông tin có sẵn trước kết luận chẩn đoán cuối cùng nhằm hạn chế hiện tượng rò rỉ nhãn.
