...
\begin{itemize}
    ...
    \item \textbf{Văn bản đi kèm:} văn bản lâm sàng hoặc văn bản lâm sàng được sinh từ siêu dữ liệu.
...
Hệ thống sinh ra các bản đồ nhiệt đóng góp cho ảnh và văn bản đi kèm nhằm khảo sát mức độ liên hệ của từng nguồn thông tin với dự đoán của mô hình.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Độ phân giải ảnh cao:} Ảnh X-quang xương thường có độ phân giải cao, trong khi nhiều mô hình hiện tại được huấn luyện trên dữ liệu với độ phân giải thấp hơn. Điều này có thể làm mất thông tin chi tiết quan trọng, ảnh hưởng đến hiệu năng phân lớp.
    \item \textbf{Mất cân bằng dữ liệu và các lớp ít mẫu:} Dữ liệu y tế thường có phân bố không đồng đều giữa các loại bệnh, trong đó một số lớp chỉ có số lượng mẫu hạn chế. Điều này đặt ra yêu cầu về thiết kế mô hình và tiêu chí đánh giá có xét đồng đều đến các lớp, nhằm hạn chế việc kết quả tổng thể bị chi phối bởi các lớp nhiều mẫu.
...
Đề tài hướng đến xây dựng và đánh giá một hệ thống học sâu đa phương thức phục vụ phân lớp bệnh lý trên ảnh X-quang xương bằng cách kết hợp thông tin hình ảnh và văn bản lâm sàng. Hệ thống được nghiên cứu trong điều kiện dữ liệu mất cân bằng, đồng thời được đánh giá về hiệu năng phân lớp, chi phí tính toán, khả năng cảnh báo dữ liệu ngoài phân phối và mức độ giải thích của dự đoán. Để làm rõ vai trò quan sát được của dữ liệu lâm sàng, cấu hình XBone-Net đầy đủ phương thức được đối chiếu trực tiếp với cấu hình XBone-Net chỉ sử dụng ảnh trên bộ dữ liệu CTCH.
...
\item Đánh giá hiệu năng phân lớp của XBone-Net so với các mô hình đối chứng trong thiết lập toàn bộ dữ liệu; trên CTCH, so sánh cấu hình đầy đủ với cấu hình chỉ ảnh để đánh giá vai trò quan sát được của văn bản lâm sàng trong điều kiện mất cân bằng với các lớp ít mẫu; đồng thời định lượng sự đánh đổi giữa số tham số cập nhật, chi phí huấn luyện và chi phí suy luận. So sánh này cũng được dùng để thảo luận khả năng thích nghi với dữ liệu đích, nhưng không thay thế kiểm định ngoài trên dữ liệu từ miền độc lập.
...
\item Đánh giá hai đầu ra hỗ trợ của hệ thống gồm cảnh báo dữ liệu ngoài phân phối bằng các điểm bất thường hậu xử lý và truy vết nguồn phụ thuộc của dự đoán bằng tích phân gradient kết hợp can thiệp đầu vào; trong đó cấu hình chỉ ảnh được sử dụng làm đối chứng để khảo sát tín hiệu bổ sung từ văn bản lâm sàng.
\end{enumerate}

\section{Đối tượng nghiên cứu}

Đối tượng nghiên cứu của đề tài là các mô hình học sâu đa phương thức trong bài toán phân lớp bệnh lý trên ảnh X-quang xương, sử dụng đồng thời thông tin hình ảnh và văn bản lâm sàng. Nghiên cứu tập trung vào các nhóm mô hình và thành phần kỹ thuật sau:
...
\item Các chiến lược dung hợp đa phương thức, bao gồm phép nối đặc trưng và cơ chế chú ý chéo, để kết hợp biểu diễn hình ảnh với thông tin văn bản lâm sàng.

\item Cấu hình XBone-Net chỉ sử dụng ảnh, đóng vai trò đối chứng theo nguồn đầu vào khi đánh giá vai trò của văn bản lâm sàng trong phân lớp, cảnh báo dữ liệu ngoài phân phối và phân tích mức phụ thuộc của dự đoán.
...
Đề tài tập trung vào bài toán phân lớp đa lớp bệnh lý xương trên ảnh X-quang, kết hợp với văn bản lâm sàng. Phạm vi cụ thể bao gồm:

\begin{itemize}
  \item \textbf{Dữ liệu:} Sử dụng bộ dữ liệu BTXRD \cite{Yao2025} gồm 10 lớp bệnh lý xương và bộ dữ liệu CTCH gồm 22 lớp chấn thương xương thu thập từ Bệnh viện Chấn thương Chỉnh hình Thành phố Hồ Chí Minh.
  \item \textbf{Dữ liệu văn bản:} Bộ dữ liệu CTCH sử dụng bệnh sử có sẵn trong bệnh án, gồm lý do vào viện, diễn tiến bệnh và tiền sử. Bộ dữ liệu BTXRD không có bệnh sử tự do nên sử dụng văn bản lâm sàng được sinh ngoại tuyến từ siêu dữ liệu. Vì mẫu câu tổng hợp có phụ thuộc vào các cờ nhóm bệnh, kết quả BTXRD chỉ phản ánh thiết lập văn bản tổng hợp và không được xem là bằng chứng tương đương với văn bản lâm sàng tự nhiên.
  \item \textbf{Đối chứng theo phương thức:} Việc so sánh XBone-Net chỉ ảnh với XBone-Net đầy đủ phương thức được thực hiện trên CTCH, nơi bệnh sử tự nhiên đi kèm từng ca được sử dụng làm nguồn văn bản. Cấu hình chỉ ảnh không nhận văn bản và không thực hiện pha khớp ngữ nghĩa ảnh-văn bản; vì vậy, chênh lệch giữa hai cấu hình phản ánh đồng thời nguồn đầu vào và quy trình huấn luyện tương ứng, không phải ước lượng nhân quả riêng của bệnh sử.
  \item \textbf{Dữ liệu mất cân bằng:} Cụm từ ''lớp ít mẫu'' trong khóa luận chỉ các lớp có số lượng quan sát thấp trong phân bố mất cân bằng của bộ dữ liệu hiện có. Đề tài không xây dựng một thiết lập riêng bằng cách giảm tỷ lệ toàn bộ dữ liệu huấn luyện để đánh giá bài toán học ít dữ liệu.
  \item \textbf{Vai trò hệ thống:} Hệ thống được thiết kế làm công cụ hỗ trợ phân tích, không thay thế vai trò của bác sĩ trong quá trình ra quyết định.
...
\begin{itemize}
\item \textbf{Câu hỏi nghiên cứu 1:} 

Trong tác vụ phân loại, XBone-Net đạt mức hiệu năng nào so với các mô hình đối chứng; trên CTCH, kết quả thay đổi như thế nào khi bổ sung văn bản lâm sàng và quy trình huấn luyện đa phương thức tương ứng so với cấu hình chỉ ảnh trong điều kiện dữ liệu mất cân bằng với các lớp ít mẫu; đồng thời mô hình đánh đổi như thế nào giữa số tham số cần cập nhật, chi phí huấn luyện và chi phí suy luận?

\item \textbf{Câu hỏi nghiên cứu 2:} 

Các thành phần do khóa luận lựa chọn cho XBone-Net, gồm quy trình huấn luyện hai pha và cơ chế dung hợp, ảnh hưởng như thế nào đến hiệu năng phân loại của mô hình?

\item \textbf{Câu hỏi nghiên cứu 3:} 

Điểm cảnh báo hậu xử lý được xây dựng từ không gian biểu diễn của từng mô hình có thể phân biệt dữ liệu CTCH trong phân phối với các bệnh lý gần miền nằm ngoài không gian nhãn ở mức nào, và việc bổ sung bệnh sử tạo ra khác biệt quan sát được ra sao giữa XBone-Net chỉ ảnh, XBone-Net đầy đủ phương thức, hai biến thể cùng BiomedCLIP tinh chỉnh toàn bộ?

\item \textbf{Câu hỏi nghiên cứu 4:} 

Tích phân gradient kết hợp với can thiệp đầu vào phản ánh mức phụ thuộc của dự đoán vào thông tin hình ảnh và văn bản như thế nào, và kết quả khác nhau ra sao giữa XBone-Net chỉ ảnh, XBone-Net đầy đủ phương thức và các cấu hình đối chứng?

\end{itemize}

\section{Đóng góp chính của đề tài}

Đóng góp cốt lõi của khóa luận là xây dựng và đánh giá XBone-Net, một phương pháp thích nghi BiomedCLIP và tối ưu hóa đặc trưng dữ liệu phục vụ cho bài toán phân lớp X-quang xương đa phương thức. Các đóng góp chính gồm:
...
\begin{enumerate}
    ...
    \item \textbf{Đánh giá có hệ thống hiệu năng và sự đánh đổi tài nguyên:} thực nghiệm với các mô hình đối chứng, cấu hình XBone-Net chỉ ảnh và các cấu hình loại bỏ thành phần cho thấy XBone-Net đạt hiệu năng cạnh tranh với các mô hình ngôn ngữ-thị giác tinh chỉnh toàn bộ, đồng thời ghi nhận lợi ích của bệnh sử cùng quy trình huấn luyện đa phương thức trên CTCH trong điều kiện mất cân bằng với các lớp ít mẫu. Mô hình chỉ cập nhật khoảng 4,13\% tổng số tham số và giảm hơn 60\% bộ nhớ GPU cực đại trong huấn luyện; đổi lại, khóa luận chỉ ra chi phí tăng về thời gian huấn luyện và suy luận.

    \item \textbf{Bổ sung đánh giá độ tin cậy và khả năng truy vết dự đoán:} xây dựng điểm cảnh báo dữ liệu ngoài phân phối từ không gian biểu diễn và sử dụng tích phân gradient kết hợp can thiệp đầu vào để khảo sát mức phụ thuộc của dự đoán vào ảnh và văn bản, trong đó cấu hình chỉ ảnh được đặt làm đối chứng trước cấu hình đầy đủ phương thức. Hai thành phần này được xem là công cụ hỗ trợ phân tích mô hình, không phải cơ chế bảo đảm an toàn hoặc bằng chứng nhân quả về quyết định lâm sàng.
\end{enumerate}
