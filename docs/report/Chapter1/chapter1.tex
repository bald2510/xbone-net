...
\item Đánh giá hiệu năng phân lớp của XBone-Net so với các mô hình đối chứng trong thiết lập toàn bộ dữ liệu, đồng thời định lượng sự đánh đổi giữa số tham số cập nhật và chi phí suy luận.

\item Thực hiện các thí nghiệm loại bỏ và thay thế thành phần để xác định ảnh hưởng của quy trình huấn luyện và cơ chế dung hợp đến các nhóm độ đo khác nhau.
