...
\item \textbf{Câu hỏi nghiên cứu 4:} Tích phân gradient kết hợp với can thiệp đầu vào phản ánh mức phụ thuộc của dự đoán vào thông tin hình ảnh và văn bản như thế nào, và kết quả khác nhau ra sao giữa XBone-Net chỉ ảnh, XBone-Net đầy đủ phương thức và các cấu hình đối chứng?
