...
\begin{itemize}
\item \textbf{Câu hỏi nghiên cứu 1:} Trong các thiết lập ít mẫu và toàn bộ dữ liệu, XBone-Net đạt mức hiệu năng phân lớp nào so với các mô hình đối chứng, đồng thời đánh đổi như thế nào giữa số tham số cần cập nhật và chi phí suy luận?

\item \textbf{Câu hỏi nghiên cứu 2:} Các thành phần do khóa luận lựa chọn cho XBone-Net, gồm quy trình huấn luyện, cách mã hóa và tiền xử lý ảnh, cơ chế dung hợp cùng đầu phân lớp, ảnh hưởng như thế nào đến quyết định lớp, chất lượng xếp hạng và hiệu chuẩn?

\item \textbf{Câu hỏi nghiên cứu 3:} Các điểm bất thường hậu xử lý trên không gian biểu diễn của XBone-Net có thể phân biệt dữ liệu trong phân phối với các dạng dữ liệu ngoài phân phối được xác định trước ở mức nào, và giới hạn của cảnh báo này khác nhau ra sao giữa dịch chuyển gần miền và dịch chuyển khác bộ dữ liệu?
...
\begin{enumerate}
\item \textbf{Phương pháp XBone-Net:} Xây dựng quy trình thích nghi BioMedCLIP cho phân lớp X-quang xương bằng LoRA, huấn luyện hai giai đoạn và mô-đun dung hợp ảnh--văn bản. CTCH sử dụng bệnh sử có sẵn trong bệnh án, còn BTXRD sử dụng văn bản tổng hợp từ siêu dữ liệu; hai nguồn được diễn giải riêng do không có mức độ xác thực lâm sàng tương đương.

\item \textbf{Bằng chứng thực nghiệm về hiệu năng và đánh đổi:} Đánh giá XBone-Net với các mô hình đối chứng trong thiết lập ít mẫu và toàn bộ dữ liệu; thực hiện loại bỏ thành phần; đồng thời đo số tham số cập nhật, số phép toán, thông lượng, độ trễ và bộ nhớ. Kết quả được dùng để xác định hiệu năng cạnh tranh và các đánh đổi của phương pháp, không nhằm chứng minh rằng việc có thêm phương thức đầu vào tự thân luôn tốt hơn.

\item \textbf{Phân tích cảnh báo dữ liệu ngoài phân phối:} Xây dựng quy trình hậu xử lý và đánh giá các điểm bất thường dựa trên khoảng cách đến tâm lớp, Mahalanobis, kNN và entropy dự đoán trong hai kịch bản dịch chuyển đã xác định. Kết quả được sử dụng để khảo sát khả năng và giới hạn của cảnh báo bổ trợ, không được xem là cơ chế bảo đảm phát hiện hoặc từ chối tự động.

\item \textbf{Phân tích nguồn phụ thuộc của dự đoán:} Kết hợp tích phân gradient, can thiệp đầu vào và đối chứng thứ tự ngẫu nhiên để khảo sát mức phụ thuộc của dự đoán vào thông tin hình ảnh và văn bản ở cấp độ tập dữ liệu và trường hợp. Phân tích này hỗ trợ truy vết đầu ra nhưng không xác lập đóng góp nhân quả, khả năng định vị tổn thương hoặc độ đúng lâm sàng.
