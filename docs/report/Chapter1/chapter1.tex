...
\item \textbf{Cảnh báo dữ liệu ngoài phân phối:}
    \[
        ...
        \begin{cases}
            ...
            \right) > \delta_{\mathrm{OOD}}, \\[4pt]
            0,
            & \text{ngược lại},
        \end{cases}
    \]
Với $s_{\mathrm{OOD}}\left(x^{\mathrm{img}},x^{\mathrm{txt}}\right)$ là điểm ngoài phân phối của mẫu đầu vào, $\delta_{\mathrm{OOD}}$ là ngưỡng cảnh báo được xác định trước và $\omega_{\mathrm{OOD}}=1$ biểu thị rằng mẫu được phát hiện là dữ liệu ngoài phân phối.
...
\begin{enumerate}
\item Đánh giá mức độ đóng góp của bệnh sử lâm sàng đối với hiệu năng phân lớp khi kết hợp với ảnh X-quang, so với thiết lập chỉ sử dụng hình ảnh.
