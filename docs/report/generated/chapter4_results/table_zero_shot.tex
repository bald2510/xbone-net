...
\hline
\multicolumn{1}{|c|}{\textbf{Dữ liệu}} & \multicolumn{1}{c|}{\textbf{Mô hình}} & \multicolumn{1}{c|}{\textbf{Acc $\uparrow$}} & \multicolumn{1}{c|}{\textbf{BAcc $\uparrow$}} & \multicolumn{1}{c|}{\textbf{Macro-F1 $\uparrow$}} & \multicolumn{1}{c|}{\textbf{Macro-AUROC $\uparrow$}} & \multicolumn{1}{c|}{\textbf{Macro-AP $\uparrow$}} \\ \hline
