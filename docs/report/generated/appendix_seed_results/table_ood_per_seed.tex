...
\caption{Kết quả OOD hậu xử lý của từng hạt giống trên kịch bản OOD ngữ nghĩa; các hàng Mahalanobis theo tâm lớp được tô xám.}
...
\caption[]{Kết quả OOD hậu xử lý của từng hạt giống trên kịch bản BTXRD; các hàng Mahalanobis theo tâm lớp được tô xám.}
\end{table}
