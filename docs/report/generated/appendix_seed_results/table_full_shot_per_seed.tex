...
\begin{longtable}{@{}L{2.85cm}C{1.05cm}*{5}{C{1.55cm}}@{}}
\caption{Kết quả khi sử dụng toàn bộ dữ liệu huấn luyện của từng hạt giống trên BTXRD}\label{tab:appendix-full-shot-seeds-btxrd}\\
\toprule
...
\renewcommand{\arraystretch}{1.08}
\begin{longtable}{@{}L{2.85cm}C{1.05cm}*{5}{C{1.55cm}}@{}}
\caption{Kết quả khi sử dụng toàn bộ dữ liệu huấn luyện của từng hạt giống trên CTCH}\label{tab:appendix-full-shot-seeds-ctch}\\
\toprule
\textbf{Mô hình} & \textbf{Hạt giống} & \textbf{Accuracy} & \textbf{BAcc} & \textbf{Macro-F1} & \textbf{Macro-AUROC} & \textbf{Macro-AUPRC} \\
\midrule
\endfirsthead
