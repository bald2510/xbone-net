...
\begin{longtable}{C{1.15cm}L{2.65cm}C{1.05cm}*{5}{C{1.35cm}}}
\caption{Kết quả mẫu học hạn chế của từng hạt giống trên BTXRD; hàng XBone-Net được tô xám để dễ đối chiếu.}\label{tab:appendix-few-shot-seeds-btxrd}\\
\toprule
...
\renewcommand{\arraystretch}{1.08}
\begin{longtable}{C{1.15cm}L{2.65cm}C{1.05cm}*{5}{C{1.35cm}}}
\caption{Kết quả mẫu học hạn chế của từng hạt giống trên CTCH; hàng XBone-Net được tô xám để dễ đối chiếu.}\label{tab:appendix-few-shot-seeds-ctch}\\
\toprule
\textbf{Thiết lập} & \textbf{Mô hình} & \textbf{Hạt giống} & \textbf{Accuracy} & \textbf{BAcc} & \textbf{Macro-F1} & \textbf{Macro-AUROC} & \textbf{Macro-AUPRC} \\
\midrule
\endfirsthead
