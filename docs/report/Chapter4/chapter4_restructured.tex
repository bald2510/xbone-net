...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{generated/chapter4_results/ood_sample_comparison.png}
\caption{Kết quả phát hiện dữ liệu ngoài phân phối bằng khoảng cách Mahalanobis theo tâm lớp trong hai kịch bản}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{generated/chapter4_results/multimodal_ig.png}
