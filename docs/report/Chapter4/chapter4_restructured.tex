...
Việc chia dữ liệu được thực hiện theo người bệnh với hạt giống ngẫu nhiên 42 và tỷ lệ mục tiêu 70/10/20. Người bệnh được nhóm theo lớp chính trước khi phân bổ để duy trì sự hiện diện của các lớp ít mẫu ở cả ba tập khi số lượng cho phép. Kết quả như được thể hiện ở Bảng \ref{tab:ctch_splits} gồm 2.265 mẫu huấn luyện, 315 mẫu Đánh giá và 669 mẫu kiểm thử và Bảng \ref{tab:ctch_pathologies} thể hiện chi tiết số lượng mẫu trong từng lớp trong các tập chia.
...
\begin{tabular}{|l|r|r|r|r|r|}
\hline
\textbf{Lớp} & \textbf{Huấn luyện} & \textbf{Đánh giá} & \textbf{Kiểm thử} & \textbf{Tổng} & \textbf{Tỷ lệ} \\ \hline
...
Ngưỡng $\tau_{95}$ được hiệu chỉnh trên tập Đánh giá. Độ đo được dùng để ước lượng tỷ lệ mẫu ngoài phân phối bị chấp nhận nhầm tại một mức giữ lại mẫu trong phân phối cố định; giá trị thấp hơn thường thuận lợi hơn.
...
\subsection{Phân tích khả năng chuyển giao của BiomedCLIP}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/full_shot_paired_f1_forest.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{images/chapter4/ctch_xbone_net_confusion_matrix_3seed.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.57\linewidth]{images/chapter4/ctch_xbone_net_pr_3seed.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.57\linewidth]{images/chapter4/ctch_xbone_net_roc_3seed.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\linewidth]{images/chapter4/ctch_xbone_net_calibration_3seed.png}
...
\input{tables/chapter4/table_few_shot_ranking}
...
\input{tables/chapter4/table_efficiency_few_shot}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/forest_accuracy.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/forest_f1_macro.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/forest_auroc_macro.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/centroid_projection.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/mahalanobis_semantic_btxrd_metrics.png}
\caption{Kết quả phát hiện dữ liệu ngoài phân phối bằng khoảng cách Mahalanobis theo tâm lớp trong hai kịch bản}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/centroid_projection_ood.png}
\caption{Kết quả phát hiện dữ liệu ngoài phân phối bằng khoảng cách Mahalanobis theo tâm lớp trong hai kịch bản}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/ood_sample_comparison.png}
\caption{Kết quả phát hiện dữ liệu ngoài phân phối bằng khoảng cách Mahalanobis theo tâm lớp trong hai kịch bản}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/attention_case_2842_img-33484-00001.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/multimodal_ig.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{images/chapter4/ig_seed456_case_57.png}
