...
\resizebox{\textwidth}{!}{%
\begin{tabular}{|L{2.4cm}|L{5.2cm}|L{5.5cm}|L{3.5cm}|}
\hline
...
Phân biệt dữ liệu ngoài phân phối & Không gian biểu diễn chứa tín hiệu giúp tách mẫu trong phân phối khỏi mẫu ngoài không gian nhãn và mẫu khác bộ dữ liệu. & So sánh điểm cosine theo tâm lớp, Mahalanobis, láng giềng gần nhất và entropy trên hai kịch bản dịch chuyển. & Diện tích dưới đường cong phân biệt; FPR@95\%TPR. \\ \hline
Nguồn thông tin của dự đoán & Ảnh toàn cục, các đơn vị ảnh cục bộ và bệnh sử có mức ảnh hưởng khác nhau; thứ tự quy đóng cần làm xác suất lớp đích giảm nhanh hơn đối chứng ngẫu nhiên. & Can thiệp từng nguồn, tích phân gradient, kiểm tra loại bỏ--khôi phục và phân tích trường hợp đúng, sai. & Mức giảm xác suất lớp đích; diện tích dưới đường cong loại bỏ; chênh lệch so với thứ tự ngẫu nhiên. \\ \hline
\end{tabular}%
}
...
Hình~\ref{fig:ctch_pr_curve} và Hình~\ref{fig:ctch_roc_curve} làm rõ khoảng cách giữa chất lượng xếp hạng và quyết định lớp. Macro-AUROC đạt $0{,}947\pm0{,}025$, trong khi Macro-AP đạt $0{,}619\pm0{,}014$. Đường cong precision--recall vẫn cao hơn rõ rệt mức phổ biến trung bình $0{,}045$, nhưng precision giảm nhanh khi recall tiến gần 1, phản ánh khó khăn trong việc duy trì độ chuẩn xác cao đồng thời trên các lớp hiếm.

\begin{figure}[H]
\centering
\includegraphics[width=0.57\linewidth]{generated/chapter4_results/ctch_xbone_net_pr_3seed.png}
\caption{Đường cong precision--recall trung bình theo lớp của XBone-Net trên CTCH}
...
So với XBone-Net, gộp trung bình làm tăng độ chính xác cân bằng $0{,}0205$, điểm F1 $0{,}0178$, Macro-AUROC $0{,}0104$ và Macro-AP $0{,}0123$ điểm, nhưng sai số hiệu chỉnh kỳ vọng tăng từ $0{,}1032$ lên $0{,}1506$. Đầu tuyến tính làm tăng độ chính xác $0{,}0538$ và điểm F1 $0{,}0331$ điểm, đồng thời làm Macro-AUROC giảm $0{,}0393$ điểm. Phép nối đặc trưng đạt sai số hiệu chỉnh thấp nhất với $0{,}0789\pm0{,}0148$, nhưng điểm F1 giảm $0{,}0133$ điểm. Các kết quả này cho thấy cấu hình phức tạp hơn không mặc nhiên tối ưu cho mọi tiêu chí.
...
Các khoảng tái lấy mẫu bắt cặp trong Hình~\ref{fig:ablation_accuracy_forest}, Hình~\ref{fig:ablation_f1_forest} và Hình~\ref{fig:ablation_auroc_forest} cho thấy sau hiệu chỉnh Holm, chỉ cấu hình chỉ huấn luyện pha 2 và cấu hình đầu tuyến tính có độ chính xác cao hơn XBone-Net trong phép so sánh hiện tại. Không biến thể nào khác biệt rõ theo điểm F1, độ chính xác cân bằng hoặc Macro-AP, trong khi XBone-Net có Macro-AUROC cao hơn đầu tuyến tính. Các phép so sánh được tính trên dự đoán của ba lần huấn luyện hiện có và không thay thế việc lặp lại thí nghiệm với số hạt giống lớn hơn.
...
Nhằm khảo sát cấu trúc hình học được hình thành trong XBone-Net, sáu không gian biểu diễn được đánh giá trên 669 mẫu kiểm thử CTCH bằng chỉ số Silhouette và Davies--Bouldin. Các chỉ số định lượng được tính trong không gian biểu diễn đầy đủ; phép chiếu PCA hai chiều chỉ được sử dụng để minh họa trực quan.
...
Hình~\ref{fig:centroid_projection} cho thấy các mẫu huấn luyện của nhiều lớp vẫn chồng lấn đáng kể trong phép chiếu hai chiều, mặc dù một số tâm lớp phân bố theo các hướng khác nhau. Một số tâm không trùng với vùng mật độ lớn của các điểm cùng lớp, có thể phản ánh mất cân bằng lớp, cấu trúc đa đỉnh hoặc sự méo khoảng cách do phép chiếu chỉ giữ một phần phương sai. Do cả mẫu và tâm trong hình đều được lấy từ tập huấn luyện, hình không được dùng để suy luận về dịch chuyển giữa tập huấn luyện và tập kiểm thử. Khoảng cách trên mặt phẳng PCA cũng không thay thế độ tương đồng cosine trong không gian biểu diễn đầy đủ.
...
Bảng~\ref{tab:rq4_ood_baselines} giữ cố định điểm Mahalanobis để so sánh ảnh hưởng của không gian biểu diễn. BiomedCLIP không mẫu đạt AUROC-OOD $0{,}6362$ trên nhóm ngoài không gian nhãn trong một lần đánh giá, cao hơn nhẹ XBone-Net; XBone-Net đạt AUPR-Out cao nhất trong nhóm các biểu diễn được huấn luyện trên kịch bản này. Trên BTXRD, phép nối đặc trưng dẫn đầu cả ba độ đo với AUROC-OOD $0{,}8966\pm0{,}0478$ và FPR@95\%TPR $0{,}5978\pm0{,}1744$. Kết quả cho thấy kiến trúc dung hợp phức tạp không mặc nhiên tạo không gian biểu diễn tốt nhất cho mọi dạng dịch chuyển.

\input{generated/chapter4_results/table_rq4_ood_baselines}

Hình~\ref{fig:centroid_projection_ood} và Hình~\ref{fig:ood_sample} bổ sung phân tích định tính bằng cách đặt một mẫu OOD trong cùng phép chiếu với các mẫu trong phân phối và các tâm lớp. Mẫu có điểm Mahalanobis $19{,}85$, thấp hơn ngưỡng đánh giá $31{,}56$ tại điểm FPR@95\%TPR, nên bị chấp nhận nhầm như dữ liệu trong phân phối và được liên hệ gần nhất với lớp gãy xương cánh tay. Ví dụ này minh họa giới hạn của điểm khoảng cách đối với OOD gần miền. Các hình chỉ mô tả vị trí tương đối trên mặt phẳng PCA; điểm OOD, tâm gần nhất và trạng thái cảnh báo được tính trong không gian biểu diễn đầy đủ.
...
\caption{So sánh định tính mẫu OOD bị chấp nhận nhầm với mẫu trong phân phối gần nhất theo điểm khoảng cách trong không gian biểu diễn}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{generated/chapter4_results/multimodal_ig_2842.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{generated/chapter4_results/multimodal_ig_3021.png}
