...
Hình~\ref{fig:ctch_pr_curve} và Hình~\ref{fig:ctch_roc_curve} làm rõ khoảng cách giữa chất lượng xếp hạng và quyết định lớp. Macro-AUROC đạt $0{,}947\pm0{,}025$, trong khi macro-AUPRC đạt $0{,}619\pm0{,}014$. Đường cong precision--recall vẫn cao hơn rõ rệt mức phổ biến trung bình $0{,}045$, nhưng precision giảm nhanh khi recall tiến gần 1, phản ánh khó khăn trong việc duy trì độ chuẩn xác cao đồng thời trên các lớp hiếm.
