...
\subsection{Kết quả}
Bảng~\ref{tab:ablation_leave_one_out_classification} so sánh XBone-Net với hai biến thể qua ba hạt giống trên bộ dữ liệu CTCH bằng ba độ đo quyết định lớp. XBone-Net đạt độ chính xác $0{,}6183$ và macro-F1 $0{,}5727$, cao hơn lần lượt $0{,}6099$ và $0{,}5628$ của biến thể Chỉ pha 2, đồng thời cao hơn $0{,}5825$ và $0{,}5622$ của biến thể Nối đặc trưng. Tuy nhiên, biến thể Nối đặc trưng đạt độ chính xác cân bằng $0{,}6199$, cao hơn mức $0{,}5935$ của XBone-Net. Như vậy, cấu hình đầy đủ có lợi thế quan sát được về độ chính xác và macro-F1, nhưng không dẫn đầu đồng thời cả ba độ đo.
