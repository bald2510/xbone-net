...
Qua các nội dung đã trình bày, chương này đã hệ thống hóa kiến trúc, tối ưu không gian biểu diễn thông qua quy trình huấn luyện và cơ chế suy luận của XBone-Net cho bài toán phân loại đa lớp ảnh X-quang xương có kết hợp thông tin lâm sàng. Các thành phần chính của phương pháp được tổng kết như sau:

\begin{enumerate}
    \item \textbf{Kết hợp ngữ cảnh lâm sàng:} XBone-Net khai thác thông tin bệnh sử và triệu chứng của bệnh nhân để bổ sung ngữ cảnh cho các dấu hiệu trên ảnh. Nhờ đó, mô hình có thể phân biệt các lớp bệnh có biểu hiện hình thái tương tự nhưng khác nhau về bối cảnh lâm sàng. Đồng thời đây cũng là kịch bản gần với thực tế lâm sàng, nơi bác sĩ thường dựa vào cả hai nguồn thông tin trên để đưa ra chẩn đoán.
    
    \item \textbf{Biểu diễn ảnh toàn cục-cục bộ:} Ảnh X-quang độ phân giải cao được biểu diễn bằng một ảnh toàn cục và bốn vùng ảnh cục bộ bổ sung thông tin tọa độ. Trong đó, hai vùng được lựa chọn nhằm duy trì độ bao phủ giải phẫu, còn hai vùng ưu tiên các vị trí giàu thông tin dựa trên đáp ứng Laplacian, entropy mức xám và tỷ lệ tiền cảnh. 
    
    \item \textbf{Thích nghi BiomedCLIP bằng LoRA:} XBone-Net kế thừa bộ mã hóa thị giác ViT-B/16 và bộ mã hóa văn bản PubMedBERT từ BiomedCLIP. Các tham số nền được giữ cố định, trong khi các ma trận LoRA được cập nhật để thích nghi biểu diễn ảnh và văn bản với miền X-quang xương.

    \item \textbf{Dung hợp đa phương thức bằng chú ý chéo hai chiều:} Chuỗi đặc trưng ảnh toàn cục-cục bộ và các token thông tin lâm sàng được tương tác theo hai hướng. Ở hướng thứ nhất, đặc trưng ảnh truy vấn các nội dung lâm sàng có liên quan; ở hướng ngược lại, biểu diễn văn bản truy vấn các bằng chứng thị giác phù hợp. Hai kết quả được tổng hợp thành một vectơ đa phương thức chung, cho phép mô hình khai thác mối liên hệ giữa dấu hiệu trên ảnh và ngữ cảnh bệnh sử thay vì chỉ ghép nối các biểu diễn toàn cục.

    \item \textbf{Chiến lược huấn luyện hai giai đoạn và phân loại nguyên mẫu:} Giai đoạn thứ nhất thích nghi không gian ảnh-văn bản bằng hàm mất mát khớp ngữ nghĩa với phân phối đích mềm, trong đó các mẫu khác nhau nhưng cùng lớp không bị xem là các cặp âm tính hoàn toàn. Giai đoạn thứ hai tối ưu mô-đun dung hợp và biểu diễn đa phương thức cho nhiệm vụ phân loại. Mỗi lớp được biểu diễn bằng một nguyên mẫu tính từ các mẫu huấn luyện, còn hàm mất mát entropy chéo có trọng số được sử dụng để giảm ảnh hưởng của sự mất cân bằng lớp.

    \item \textbf{Suy luận trực tuyến và phát hiện ngoài phân phối:} Trong quá trình trực tuyến, toàn bộ tham số mô hình và các nguyên mẫu lớp được cố định. Nhãn dự đoán được xác định dựa trên độ tương đồng côsin giữa biểu diễn của mẫu mới và các nguyên mẫu lớp. Bên cạnh kết quả phân loại, khoảng cách Mahalanobis được sử dụng như một cơ chế hậu xử lý để cảnh báo các mẫu ngoài phân phối mà không yêu cầu dữ liệu OOD trong quá trình huấn luyện.
\end{enumerate}