...
\begin{enumerate}
    \item \textbf{Biểu diễn ảnh toàn cục-cục bộ:} Ảnh X-quang độ phân giải cao được biểu diễn bằng một ảnh toàn cục và bốn vùng ảnh cục bộ. Trong đó, hai vùng được lựa chọn nhằm duy trì độ bao phủ giải phẫu, còn hai vùng ưu tiên các vị trí giàu thông tin dựa trên đáp ứng Laplacian, entropy mức xám và tỷ lệ tiền cảnh. Các vùng được ánh xạ về ảnh nguồn trước khi trích xuất và được bổ sung biểu diễn tọa độ, qua đó kết hợp bối cảnh giải phẫu tổng thể với các dấu hiệu tổn thương khu trú.

    \item \textbf{Thích nghi BiomedCLIP bằng LoRA:} XBone-Net kế thừa bộ mã hóa thị giác ViT-B/16 và bộ mã hóa văn bản PubMedBERT từ BiomedCLIP. Các tham số nền được giữ cố định, trong khi các ma trận LoRA được cập nhật để thích nghi biểu diễn ảnh và văn bản với miền X-quang xương. Thiết kế này làm giảm số lượng tham số cần huấn luyện và hạn chế nguy cơ quá khớp trong điều kiện dữ liệu y khoa có quy mô hạn chế và phân bố lớp không đồng đều.
