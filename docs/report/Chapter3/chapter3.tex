...
Với dữ liệu ảnh X-quang xương được thu thập từ Bệnh viện Chấn thương Chỉnh hình TP.HCM, nhóm nhận thấy rằng các báo cáo khám tổng quát của bác sĩ thường có ba phần quan trọng nhất: (1) lời khai của bệnh nhân, (2) tiền sử bệnh lý và (3) phân tích ảnh X-quang. Trong đó, phần phân tích ảnh X-quang chứa các nhận định trực tiếp của bác sĩ dựa trên hình ảnh, bao gồm mô tả tổn thương và kết luận chẩn đoán, nên mang giá trị thông tin cao nhất.

Tuy nhiên, nội dung của phần này thực chất được xây dựng từ chính ảnh X-quang và thường chứa các thông tin gần tương đương với nhãn phân loại của bài toán hướng đến, chẳng hạn như loại tổn thương, vị trí tổn thương hoặc kết luận chẩn đoán. Do đó, nếu sử dụng phần phân tích ảnh X-quang làm đầu vào cùng với ảnh trong quá trình huấn luyện, mô hình sẽ được cung cấp thông tin suy luận trực tiếp từ mục tiêu dự đoán, dẫn đến hiện tượng rò rỉ thông tin (information leakage). Khi đó, kết quả đánh giá có thể bị đánh giá quá cao do mô hình học từ thông tin đã chứa đáp án thay vì khai thác mối quan hệ giữa ảnh X-quang và các thông tin lâm sàng thực sự.

Vì vậy, trong nghiên cứu này, phần phân tích ảnh X-quang được loại bỏ khỏi dữ liệu văn bản đầu vào, sử dụng để tạo ra nhãn phân loại, không sử dụng chẩn đoán xác định vì nó được tổng hợp từ kết quả của nhiều . Mô hình chỉ sử dụng các thông tin có sẵn trước khi bác sĩ đọc ảnh, bao gồm lời khai của bệnh nhân và tiền sử bệnh lý. Cách xây dựng dữ liệu này phản ánh đúng quy trình chẩn đoán lâm sàng trong thực tế, đồng thời đảm bảo tính khách quan và khả năng tổng quát của mô hình.

\subsection{Ý tưởng đề xuất}
...
nhãn được quyết định bởi khoảng cách đến các prototype trong không gian biểu diễn chung, thay vì lớp phân loại truyền thống làm ràng buộc mô hình phân loại vào các nhãn đã biết, giúp phát hiện dữ liệu ngoài phân phối khi khoảng cách đó vượt quá ngưỡng xác định.
...
Thay vì tính toán giá trị prototype cố định bằng trung bình cộng của các mẫu hỗ trợ, các prototype lớp $c_k$ được định nghĩa là các vector trọng số có thể học được (learnable parameters) và được cập nhật trực tiếp qua quá trình lan truyền ngược (backpropagation). Khoảng cách giữa embedding hợp nhất $z_i$ và các prototype $c_k$ được sử dụng để đưa ra dự đoán đa nhãn, đồng thời hỗ trợ phát hiện dữ liệu ngoài phân phối thông qua ngưỡng khoảng cách đến prototype gần nhất. Nghiên cứu sử dụng khoảng cách Cosine (Cosine Distance) giữa đặc trưng đã chuẩn hóa L2 để đảm bảo sự ổn định trong không gian nhúng của mô hình đa phương thức:
\begin{equation}
